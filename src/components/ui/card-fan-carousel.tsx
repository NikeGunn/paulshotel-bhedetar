          ...
          {cards.map((card, index) => {
            const image = (
              <div className="relative h-full w-full overflow-hidden">
                ...
                />
                {card.caption && (
                  <span className="absolute inset-x-0 bottom-0 z-20 bg-gradient-to-t from-brand-950/85 to-transparent px-4 pb-3 pt-8 text-center font-display text-sm font-semibold text-cream">
                    {card.caption}
                  </span>
                )}
              </div>
